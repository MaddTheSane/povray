...
//image & Quality
	...
	cYSubsetStart				=18,
	cYSubsetEnd					=19,
	ImageTypePopupTag		=20,
	BithDepthPopupTag		=21,
	cDontDisplay				=22,
	cDitheringOn				=23,
	cSamplingOn					=24,
	cFileGammaOn				=25,
	cRatioPresets				=26,
	cRatioOnOff					=27,
	cPresetsImageSizes	=28,
	cSubsetToFullSize		=29,
	//bounding & threads
	cRedirectTextStreamsOnOff =30,
	cAutoBoundingOnOff				=31,
	cBSPBoundingMethodOnOff		=32,
	cRenderBlockStepOn				=33,
	
	//clock
	cAnimationOnOff		=40,
	cFrameStepOn			=41,
	//misc
	cRedirectAllOutputImagesOnOff	=50,
	cRedirectAllOutputImagesPath	=51,
//files @ paths
