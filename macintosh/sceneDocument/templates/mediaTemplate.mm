...
+(NSMutableDictionary *) createDefaults:(NSUInteger) templateType
{
	NSMutableDictionary *initialDefaults=[NSMutableDictionary dictionaryWithObjectsAndKeys:
		@(NSOffState),									@"mediaDontWrapInMedia",
		@(NSOffState),									@"mediaIgnorePhotonsOn",
		@(NSOffState),									@"mediaAbsorptionGroupOn",
		[NSKeyedArchiver archivedDataWithRootObject:[MPColorWell whiteColorAndFilter:NO]],	@"mediaAbsorptionGroupColorWell",
		@(NSOffState),									@"mediaEmissionGroupOn",
		[NSKeyedArchiver archivedDataWithRootObject:[MPColorWell whiteColorAndFilter:NO]],	@"mediaEmissionGroupColorWell",
		@(NSOffState),									@"mediaDensityGroupOn",
		[NSNumber numberWithInt:cFirstCell],										@"mediaDensityMatrix",
		@(NSOnState),									@"mediaScatteringGroupOn",
		[NSNumber numberWithInt:cIsotropic],										@"mediaScatteringTypePopUp",
		@(NSOffState),	 								@"mediaScatteringColorWell",
		@"0.0",																					@"mediaScatteringEccentricityEdit",
		@(NSOffState),	 								@"mediaScatteringExtinctionOn",
		@"0.5",																					@"mediaScatteringExtinctionEdit",
		[NSKeyedArchiver archivedDataWithRootObject:[MPColorWell whiteColorAndFilter:NO]],	@"mediaScatteringColorWell",
		[NSNumber numberWithInt:cMethod1],										@"mediaSamplingMethodPopUp",
		@(NSOffState),									@"mediaSamplingIntervalsOn",
		@"1.0",																					@"mediaSamplingIntervalsEdit",
		@(NSOffState),									@"mediaSamplingSamplesOn",
		@"1",																						@"mediaSamplingSamplesMinEdit",
		@"1",																						@"mediaSamplingSamplesMaxEdit",
		@(NSOffState),									@"mediaSamplingJitterOn",
		@"0.0",																					@"mediaSamplingJitterEdit",
		@(NSOffState),									@"mediaSamplingAaDepthOn",
		@"4.0",																					@"mediaSamplingAaDepthEdit",
		@(NSOffState),									@"mediaSamplingAaThresholdOn",
		@"0.1",																					@"mediaSamplingAaThresholdEdit",
		@(NSOffState),									@"mediaSamplingConfidenceOn",
		@"0.9",																					@"mediaSamplingConfidenceEdit",
		@(NSOffState),									@"mediaSamplingVarianceOn",
		@"1/128",																				@"mediaSamplingVarianceEdit",
		@(NSOffState),									@"mediaSamplingRatioOn",
