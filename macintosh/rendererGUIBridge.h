//******************************************************************************
///
/// @file /macintosh/renderGUIBridge.h
///
/// @todo   What's in here?
///
/// @copyright
...
#ifndef renderGUIBridge_h
#define renderGUIBridge_h

#import "vfe.h"
#import "renderDispatcher.h"
// Mac parse error ( open file and point to error line)
...
namespace vfe
{
	...
	void ProcessSession(vfe::vfeStatusFlags flags);
