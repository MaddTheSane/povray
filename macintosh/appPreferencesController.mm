...
+(void) initialize
{
	...
	[NSMutableDictionary dictionaryWithObjectsAndKeys:
	 ...
	 @0,																	@"numericBlockPoint",
	 @2,																	@"tabDistance",
	 @1,																	@"indexOfAppPrefsSelectedTabViewItem",
	 @"",																	@"mInsertMenuMainDirectoryEdit",
	 @100.0f,															@"mInsertMenuImageScaleSlider",
	 @10,																	@"NSRecentDocumentsLimit",
	 @(NSOffState),												@"AlwaysPutPreviewwindowInFrontButton",
	 @(NSOffState),												@"OnlyPutPreviewwindowInFrontForFirstFrameOfAnimationButton",
	 nil];
