...
// if preprocessor macro "BackendIs37" is defined
// use old file naming
#ifdef BackendIs37
	#import "parse.h"
	#import "reswords.h"
	#define lastTokenValue pov::LAST_TOKEN
#else
	#import "parser.h"
	#import "reservedwords.h"
	#define lastTokenValue pov::TOKEN_COUNT
#endif
...
+(void) initializeSyntaxHightlighting
{
	...
	for (NSInteger i = 0; i < lastTokenValue; i++)
	{
		sNumberOfKeyWords++;
