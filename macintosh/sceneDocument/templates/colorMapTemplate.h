...
{
    IBOutlet colormapPreview *cMapPreview;
    IBOutlet NSButton			*colormapUseGrayColor;
    IBOutlet NSButton			*colormapFilterOn;
    IBOutlet NSButton			*colormapTransmitOn;
    
    unsigned int mColorClickInRow;
    ColorCell *mColorCell;
}
